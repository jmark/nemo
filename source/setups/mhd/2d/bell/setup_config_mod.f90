...
!real(dp), parameter :: stop_time = 10.0
real(dp), parameter :: stop_time = 0.5
...
real(dp), parameter :: dt_checkpoint = 0.1
...
real(dp), parameter :: blast_sigma  = 0.08
...
real(dp), parameter :: bell_magx_sigma = 0.03
real(dp), parameter :: bell_magx_normalized = 1.0_dp/SQRT((2*pi)**N_DIMS)/bell_magx_sigma**N_DIMS

!! -------------------------------------------------------------------------- !!

real(dp), parameter :: dens0 = 1.0_dp
real(dp), parameter :: pres0 = 1.0_dp
real(dp), parameter :: ener0 = 6.0_dp

real(dp), parameter :: velx0 = 0.0_dp
real(dp), parameter :: vely0 = 0.0_dp
real(dp), parameter :: velz0 = 0.0_dp

real(dp), parameter :: magx0 = 2.0_dp
...
! real(dp), parameter :: GLM_ch = 0.5_dp
! real(dp), parameter :: GLM_alpha = 2.0_dp
