...
real(dp), parameter :: stop_time = 0.2_dp
...
real(dp), parameter :: densL = 1.0_dp
real(dp), parameter :: presL = 1.0_dp

real(dp), parameter :: densR = 0.125_dp
real(dp), parameter :: presR = 0.1_dp

real(dp), parameter :: velxL = 0.0_dp
