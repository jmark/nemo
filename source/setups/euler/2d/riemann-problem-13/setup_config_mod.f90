...
real(dp), parameter :: dens_UL =  1.0625_dp
real(dp), parameter :: velx_UL =  0.00_dp
real(dp), parameter :: vely_UL =  0.8145_dp
real(dp), parameter :: pres_UL =  0.40_dp

real(dp), parameter :: dens_LL =  0.5313_dp
real(dp), parameter :: velx_LL =  0.00_dp
real(dp), parameter :: vely_LL =  0.4726_dp
real(dp), parameter :: pres_LL =  0.40_dp

real(dp), parameter :: dens_UR =  2.00_dp
real(dp), parameter :: velx_UR =  0.0_dp
real(dp), parameter :: vely_UR =  0.3_dp
real(dp), parameter :: pres_UR =  1.00_dp

real(dp), parameter :: dens_LR =  1.0_dp
real(dp), parameter :: velx_LR =  0.00_dp
real(dp), parameter :: vely_LR = -0.30_dp
real(dp), parameter :: pres_LR =  1.00_dp

real(dp), parameter :: kappa = 1.4_dp

real(dp), parameter :: xpivot = 0.0_dp
real(dp), parameter :: ypivot = 0.0_dp
