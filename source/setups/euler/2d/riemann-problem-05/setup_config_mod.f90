...
real(dp), parameter :: dens_UL =  1.0_dp
real(dp), parameter :: velx_UL =  0.75_dp
real(dp), parameter :: vely_UL =  0.5_dp
real(dp), parameter :: pres_UL =  1.0_dp

real(dp), parameter :: dens_LL =  3.0_dp
real(dp), parameter :: velx_LL =  0.75_dp
real(dp), parameter :: vely_LL = -0.5_dp
real(dp), parameter :: pres_LL =  1.0_dp

real(dp), parameter :: dens_UR =  2.0_dp
real(dp), parameter :: velx_UR = -0.75_dp
real(dp), parameter :: vely_UR =  0.5_dp
real(dp), parameter :: pres_UR =  1.0_dp

real(dp), parameter :: dens_LR =  1.0_dp
real(dp), parameter :: velx_LR = -0.75_dp
real(dp), parameter :: vely_LR = -0.5_dp
