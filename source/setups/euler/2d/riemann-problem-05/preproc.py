...
mk.add(equations + '/riemann/roe-entropy-fix-no-carbuncle/riemann_mod.f90',alias='riemann_north_mod')
mk.add(equations + '/riemann/roe-entropy-fix-no-carbuncle/riemann_mod.f90',alias='riemann_south_mod')
mk.add(equations + '/riemann/roe-entropy-fix-no-carbuncle/riemann_mod.f90',alias='riemann_west_mod')
mk.add(equations + '/riemann/roe-entropy-fix-no-carbuncle/riemann_mod.f90',alias='riemann_east_mod')
