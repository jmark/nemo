...
setup = home + '/source/setups/euler/2d/conservation'
...
mk.add(equations + '/riemann/rusanov/riemann_mod.f90',alias='riemann_north_mod')
mk.add(equations + '/riemann/rusanov/riemann_mod.f90',alias='riemann_south_mod')
mk.add(equations + '/riemann/rusanov/riemann_mod.f90',alias='riemann_west_mod')
mk.add(equations + '/riemann/rusanov/riemann_mod.f90',alias='riemann_east_mod')
