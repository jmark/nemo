...
real(dp), parameter :: dens_UL =  0.80_dp
real(dp), parameter :: velx_UL =  0.00_dp
real(dp), parameter :: vely_UL =  0.00_dp
real(dp), parameter :: pres_UL =  1.00_dp

real(dp), parameter :: dens_LL =  1.00_dp
real(dp), parameter :: velx_LL =  0.00_dp
real(dp), parameter :: vely_LL =  0.7276_dp
real(dp), parameter :: pres_LL =  1.00_dp

real(dp), parameter :: dens_UR =  1.00_dp
real(dp), parameter :: velx_UR =  0.7276_dp
real(dp), parameter :: vely_UR =  0.00_dp
real(dp), parameter :: pres_UR =  1.00_dp

real(dp), parameter :: dens_LR =  0.5313_dp
real(dp), parameter :: velx_LR =  0.00_dp
real(dp), parameter :: vely_LR =  0.00_dp
real(dp), parameter :: pres_LR =  0.40_dp
