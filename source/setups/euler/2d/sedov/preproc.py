...
setup = home + '/source/setups/euler/2d/sedov'
...
# mk.add(equations + '/riemann/roe-entropy-fix-no-carbunbcle/riemann_mod.f90',alias='riemann_inner_mod')

#mk.add(equations + '/riemann/roe-entropy-fix/riemann_mod.f90',alias='riemann_inner_mod')
...
for face in 'north south west east'.split():
    mk.add(equations + '/riemann/hlle/riemann_mod.f90',alias='riemann_{0}_mod'.format(face))

# mk.add(equations + '/riemann/eulerian-slip-wall/riemann_mod.f90',alias='riemann_north_mod')
# mk.add(equations + '/riemann/eulerian-slip-wall/riemann_mod.f90',alias='riemann_south_mod')
# mk.add(equations + '/riemann/eulerian-slip-wall/riemann_mod.f90',alias='riemann_west_mod')
# mk.add(equations + '/riemann/eulerian-slip-wall/riemann_mod.f90',alias='riemann_east_mod')
