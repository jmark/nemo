...
real(dp), parameter :: velx_UL =  0.0_dp
real(dp), parameter :: vely_UL =  0.2145_dp
real(dp), parameter :: pres_UL =  0.4_dp

real(dp), parameter :: dens_LL =  0.5197_dp
real(dp), parameter :: velx_LL =  0.0_dp
real(dp), parameter :: vely_LL = -1.1259_dp
real(dp), parameter :: pres_LL =  0.4_dp

real(dp), parameter :: dens_UR =  2.0_dp
real(dp), parameter :: velx_UR =  0.0_dp
real(dp), parameter :: vely_UR = -0.3_dp
real(dp), parameter :: pres_UR =  1.0_dp

real(dp), parameter :: dens_LR =  1.0_dp
real(dp), parameter :: velx_LR =  0.0_dp
real(dp), parameter :: vely_LR = -0.4_dp
