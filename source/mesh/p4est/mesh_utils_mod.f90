...
# define p4est_ghost_exchange_contiguous p8est_ghost_exchange_contiguous

# define p4est_connectivity_new_periodic p8est_connectivity_new_periodic
# define p4est_connectivity_new_unitsquare p8est_connectivity_new_unitcube
# endif
